...
//		JISystem.setJavaCoClassAutoCollection(false);
		try {
			...
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#A相电压").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#A相电流").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#主机温度").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#冷却剂温度").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#分离前压力").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#加载压力").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#加载时间").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#卸载压力").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#报警号").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#排气压力").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#排气温度").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#控制状态字").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#正向有功总电能").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#警告号").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#运行时间").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.1#远程功能开关").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.AI-1#有功功率").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.压力").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.瞬时流量").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.瞬时功率").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.补偿后流量").read(true).getValue().getObject());			
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.露点1").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.总功率").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.总电量").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.电量1").read(true).getValue().getObject());
			f1.add(group.addItem("Siemens Ethernet1.S7-200 SMART1.功率因数1").read(true).getValue().getObject());
			
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#A相电压").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#A相电流").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#主机温度").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#冷却剂温度").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#分离前压力").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#加载压力").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#加载时间").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#卸载压力").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#报警号").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#排气压力").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#排气温度").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#控制状态字").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#正向有功总电能").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#警告号").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#运行时间").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.2#远程功能开关").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.AI-2#有功功率").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.压力").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.瞬时流量").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.瞬时功率").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.补偿后流量").read(true).getValue().getObject());			
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.露点1").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.总功率").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.总电量").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.电量2").read(true).getValue().getObject());
			f2.add(group.addItem("Siemens Ethernet1.S7-200 SMART2.功率因数2").read(true).getValue().getObject());
			                                                    
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#A相电压").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#A相电流").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#主机温度").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#冷却剂温度").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#分离前压力").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#加载压力").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#加载时间").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#卸载压力").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#报警号").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#排气压力").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#排气温度").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#控制状态字").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#正向有功总电能").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#警告号").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#运行时间").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.3#远程功能开关").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.AI-3#有功功率").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.压力").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.瞬时流量").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.瞬时功率").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.补偿后流量").read(true).getValue().getObject());			
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.露点1").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.总功率").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.总电量").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.电量3").read(true).getValue().getObject());
			f3.add(group.addItem("Siemens Ethernet1.S7-200 SMART3.功率因数3").read(true).getValue().getObject());
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
...
//		opcDataKyjInsertB.setKyjRealDataTable(f1,f2,f3);
