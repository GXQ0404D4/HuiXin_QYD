 ...
 * @version 创建时间：2020年1月3日 上午9:28:07 类说明 ScrewMachine 螺杆机数据获取
 */
@Mapper
@Repository
public interface ScrewMachineDao {
	...
	// hour表持久化到数据库
	// 空压机数据持久化到数据库
	@Insert("INSERT INTO screw_machine_hour (LGJ26,LGJ27,LGJ28,LGJ_time,LGJ_datatime,state,ScrewMachine_name) VALUES"
			+ "(#{sm.LGJ26},#{sm.LGJ27},#{sm.LGJ28},NOW(),NOW(),1,#{sm.ScrewMachine_name})")
	void setScrewMachineDataHour(@Param("sm") ScrewMachine sm);
