...
//	@Async
	...
	public  void getCentrifugeData() {
		SiemensS7Net siemensPLC = SiemensPlcConfig2.getSiemensPLC();
		...
		if (siemensPLC.ConnectServer().IsSuccess) {
			...
			System.out.println("failed:" +siemensPLC.ConnectServer().Message+"离心机异常");
		}
		siemensPLC.ConnectClose();
			// 数据读取完毕 获取当前时间
		System.out.println(" ");
		System.out.println("持久化到离心机+222" +  new SimpleDateFormat("yyyy/MM/dd-HH:mm:ss:SSS").format(new Date()));
		System.out.println(" ");
	}
