...
public final class DryingMachinePage2 {
	...
	public Map <String,Object> getDryingMachineData2() {
		...
		if (connect.IsSuccess) {
			...
			SJGZJData.put("SJGZJ11",siemens_net.ReadBool(GZJ0_21).Content);
			SJGZJData.put("SJGZJ12",siemens_net.ReadBool(GZJ0_22).Content);
			SJGZJData.put("SJGZJ13",siemens_net.ReadBool(GZJ0_23).Content);
			SJGZJData.put("SJGZJ14",siemens_net.ReadBool(GZJ0_24).Content);
			SJGZJData.put("SJGZJ15",siemens_net.ReadBool(GZJ0_25).Content);
			SJGZJData.put("SJGZJ16",siemens_net.ReadBool(GZJ0_26).Content);
			SJGZJData.put("SJGZJ17",siemens_net.ReadBool(GZJ0_27).Content);
			SJGZJData.put("SJGZJ18",siemens_net.ReadBool(GZJ0_28).Content);
			SJGZJData.put("SJGZJ19",siemens_net.ReadBool(GZJ0_29).Content);
