...
import com.ktcn.dao.report.monthDao.AirDao;
...
@Service
@Transactional
public class AirSerciceImpl implements AirService {
	...
	public Map<String, Object> find(String pageSize, int sizeNum, String eqName, String time1, String time2) {
		...
		// 获取数据
		List<ScrewMachine> list = airDao.find(eqName,time1,time2,x,sizeNum);
