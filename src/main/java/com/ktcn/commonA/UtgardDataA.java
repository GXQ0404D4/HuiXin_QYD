...
import com.ktcn.utils.OpcDataKyjInsertA;
...
public class UtgardDataA {
	...
	@Autowired
	OpcDataKyjInsertA opcDataKyjInsert;
...
//	@Scheduled(cron = "0/1 * * * * ?")
	public void SwitchData() {
		...
		// 获取IP地址
				...
				fl.clear();
				// 查询数据库所有采集通道点位
				List<String> allAddress = kyjOpcAddress1.getListAddress();
...
//				System.out.println(format + "服务开启读值￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥￥");
				for (int i = 0; i < allAddress.size(); i++) {
					...
					String itemId = address1.toString(); // 项的名字按实际，没有实际PLC，用的模拟器：simulator
					// 启动服务
...
//				System.out.println(format2 + "服务读值完毕%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
				  ...
				  opcDataKyjInsert.setKyjDataTable(fl);
