		...
		String sql = new SQL() {
			// 编写拼接SQL代码块
			{
				...
				if (current_timeA != null && !"".equals(current_timeA) && current_timeB != null
					...
					// 任务名称
					String s = "`LGJ_datatime` BETWEEN '" + current_timeA + "' AND '" + current_timeB + "'";
					WHERE(s);
				}
				if (current_timeA != null && !"".equals(current_timeA)) {
					...
					// 任务名称
					String s = "`LGJ_datatime` BETWEEN '" + current_timeA + "' AND '" + nowDate + "'";
					WHERE(s);
				}
				if (current_timeB != null && !"".equals(current_timeB)) {
					// 任务名称
					String s = "`LGJ_datatime` BETWEEN '1970-01-01 00:00:00' AND '" + current_timeB + "'";
					WHERE(s);
				}
				if (current_timeA == null && "".equals(current_timeA) && current_timeB == null
						&& "".equals(current_timeB)) {
					...
					String nowDate = format.format(date);
					// 任务名称
					String s = "`LGJ_datatime` BETWEEN '1970-01-01 00:00:00' AND '" + nowDate + "'";
					WHERE(s);
				}
			}
		}.toString();
