...
public final class ScrewMachinePage {
	...
	public Map <String,Object> getScrewMachineData1() {
		...
		if (connect.IsSuccess) {
			...
			SJBP1.put("SJBP_A2",siemens_net.ReadFloat(LGJ7_25).Content);
			SJBP1.put("SJBP_A3",siemens_net.ReadFloat(LGJ7_26).Content);
			SJBP1.put("SJBP_A4",siemens_net.ReadFloat(LGJ7_27).Content);
	...
	public Map <String,Object> getScrewMachineData2() {
		...
		if (connect.IsSuccess) {
			...
			SJBP2.put("SJBP_B2",siemens_net.ReadFloat(LGJ8_25).Content);
			SJBP2.put("SJBP_B3",siemens_net.ReadFloat(LGJ8_26).Content);
			SJBP2.put("SJBP_B4",siemens_net.ReadFloat(LGJ8_27).Content);
